...
require (
	...
	k8s.io/api v0.17.16 // github.com/kubernetes/api
	k8s.io/apiextensions-apiserver v0.17.0 // github.com/kubernetes/apiextensions-apiserver
	k8s.io/apimachinery v0.17.16 // github.com/kubernetes/apimachinery
	k8s.io/client-go v0.17.16 // github.com/kubernetes/client-go
)
